...
//                     : _buildEditableList(), // Заменяем на новый метод
...
// // Замените _buildEditableList
//   Widget _buildEditableList() {
//     // Создаем список элементов для drag_and_drop_lists
//     List<DragAndDropItem> dragAndDropItems = items.asMap().entries.map((entry) {
...
//     // Создаем один список со всеми элементами
//     List<DragAndDropList> lists = [
//       DragAndDropList(
//         header: Container(), // Пустой заголовок
...
//           final movedItem = items.removeAt(oldItemIndex);
//           items.insert(newItemIndex, movedItem);
//         });

//         // Обновляем позиции
//         _updatePositionsExtended(items[newItemIndex]['id']);
//       },
//       onListReorder: (oldListIndex, newListIndex) {
//         // У нас только один список, поэтому этот метод не используется
//       },
//       listPadding: EdgeInsets.symmetric(horizontal: 0, vertical: 8),
//       itemDivider: Container(height: 4), // Отступ между элементами
...
//           BoxDecoration(), // Пустая декорация для списка
//       axis: Axis.vertical,
//       listWidth: double.infinity,
//       listDraggingWidth: double.infinity,
//       contentsWhenEmpty: Container(), // Контент когда список пустой
//     );
//   }

// // Упрощенная версия _buildTaskItemWidget
...
// // Обновленная версия _buildRawItem
...
//               // Ставим таймер, чтобы понять что это long press
//               _longPressTimer = Timer(Duration(milliseconds: 600), () {
//                 _longPressActive = true;
//                 print('_longPressActive = true');
//                 // Тут можно визуально показать "selected" или "поднятие"
//               });
//             }
//           : null,
//       onPointerMove: _canEdit
//           ? (event) {
//               if (_longPressActive && _startPosition != null) {
//                 if ((event.position - _startPosition!).distance > 5) {
//                   _wasDragged = true;
//                   print('_wasDragged = true');
//                   // Тут твоя логика старта drag
//                 }
//               }
//             }
//           : null,
...
//               _longPressTimer?.cancel();
//               print(_wasDragged);
//               print(_longPressActive);
//               if (_longPressActive && !_wasDragged) {
//                 // Был long press, но без перемещения — показываем опции!
...
//           isFirst: index == 0,
//           inDrag: false, // drag_and_drop_lists управляет этим внутренне
//           //itemAnimation: controller,
//           //dragAnimation: _dummyAnimation,
